...
public class LinearSearchTest {
    ...
    public void testIntArrFind5atIndex2() {
        int ret = LinearSearch.linearSearch(intArr, 5);
    ...
    public void testIntArrFind10atIndex4() {
        int ret = LinearSearch.linearSearch(intArr, 10);
    ...
    public void testIntArrDontFind11() {
        int ret = LinearSearch.linearSearch(intArr, 11);
    ...
    public void testStringArrFindDatIndex1() {
        int ret = LinearSearch.linearSearch(strArr, "d");
    ...
    public void testStringArrFindMatIndex4() {
        int ret = LinearSearch.linearSearch(strArr, "m");
        assertThat(ret).isEqualTo(4);
    }
    ...
    public void testStringArrDontFindN() {
        int ret = LinearSearch.linearSearch(strArr, "n");
